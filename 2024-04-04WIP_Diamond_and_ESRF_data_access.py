...
DLS_drop_dir = DLS_mother_directory / 'Drop3_5pc_POPC_2pent_DoD_2'
...
RH_file = Path(r'C:\Users\jackm\OneDrive - University of Bath\PhD\Acoustic levtitation beamtimes\Diamond beamtime February 2024\Diamond RH data\drop3_POPC_pentanol_DOD_RH_RAMP22_02_2024-20-46.txt')

### FUNCTION CALLS ###


t_vals, filter_data, q_values = plot_multi_file_one_pos_time_RH_2('DLS', 'SAXS', 
                                                             start_pos = 0, end_pos = 12, 
                                                             n_pos = 13, 
                                                             start_file_no = 13, N_files = 'all',
                                                             range_min = -0,
                                                             range_max = 1,
                                                             t_offset = 30
                                                             )
